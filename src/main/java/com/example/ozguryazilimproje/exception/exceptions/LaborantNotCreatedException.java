...
public class LaborantNotCreatedException extends RuntimeException{
    ...
    public  LaborantNotCreatedException (Language language,IFriendlyMessageCode iFriendlyMessageCode,String message){
        ...
        log.error("[LaborantNotCreatedException]-> message: {} developer message: {}",FriendlyMessageUtils.getFriendlyMessage(language,iFriendlyMessageCode),message);
