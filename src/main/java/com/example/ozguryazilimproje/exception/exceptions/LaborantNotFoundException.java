...
public class LaborantNotFoundException extends RuntimeException {
    ...
    public  LaborantNotFoundException (Language language,IFriendlyMessageCode iFriendlyMessageCode,String message){
        ...
        log.error("[LaborantNotFoundException]-> message: {} developer message: {}",FriendlyMessageUtils.getFriendlyMessage(language,iFriendlyMessageCode),message);
