...
public class RoleNotFoundException extends RuntimeException{
    ...
    public RoleNotFoundException(Language language, IFriendlyMessageCode iFriendlyMessageCode, String message){
        ...
        log.error("[RoleNotFoundException]-> message: {} developer message {}",FriendlyMessageUtils.getFriendlyMessage(language,iFriendlyMessageCode),message);
    }
}
