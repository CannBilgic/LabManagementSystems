...
public class ImageNotFoundException extends  RuntimeException{
    ...
    public ImageNotFoundException(Language language, IFriendlyMessageCode iFriendlyMessageCode,String message) {
        ...
        log.error("[ImageNotFoundException]-> message:{} developer message: {}",FriendlyMessageUtils.getFriendlyMessage(language,iFriendlyMessageCode),message);
